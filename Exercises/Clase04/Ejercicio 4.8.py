...
#%% Calcular total comprado y vendido usando comprensi�n de listas
# Es m�s f�cil que hacer un loop for como arriba... todo en una linea de codigo

costo_camion = sum([s['cajones']*s['precio'] for s in camion])
total_vendido = sum([s['cajones']*precios[s['nombre']] for s in camion])
