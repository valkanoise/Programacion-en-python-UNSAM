...
'''Defino funciÃ³n para crear una lista con varios diccionarios
adentro. Cada dict tendrÃ¡ {nombre fruta, cantidad cajones, precio}'''
...
'''Creo una funciÃ³n que crearÃ¡ un diccionario que incluirÃ¡ los
nombres de frutas y sus precios. Si del archivo que uso para crear
el dict hay algÃºn dato faltante o sea, IndexError la funciÃ³n
informa la lÃ­nea del error y cuÃ¡l es el contenido de esa linea'''
